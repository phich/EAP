using EAP.Core.AccountHelper.Interfaces;
using EAP.Core.AccountHelper.Model;
...
namespace EAP.Core.AccountHelper
{
    public class AccountManager : IAccountManager
    {
        ...
        //public AccountManager(RoleManager<ApplicationRole> roleManager, UserManager<ApplicationUser> userManager, UserDBContext context)
        //{
        //    _context = context;
